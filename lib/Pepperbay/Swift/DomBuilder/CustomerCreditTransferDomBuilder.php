...
namespace Pepperbay\Swift\DomBuilder;

use Pepperbay\Common\PaymentInformation;
use Pepperbay\Common\TransferFile\TransferFileInterface;
...
use Pepperbay\Common\DomBuilder\BaseDomBuilder;
use Pepperbay\Common\Util\IBANChecker;
...
class CustomerCreditTransferDomBuilder extends BaseDomBuilder
{
    ...
    public function visitPaymentInformation(PaymentInformation $paymentInformation)
    {
        ...
        $this->currentPayment->appendChild($this->createElement('ChrgBr', 'SHAR'));
